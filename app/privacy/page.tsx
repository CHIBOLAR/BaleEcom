  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Collection</h2>
          <p>
          ...
          <p className="font-semibold text-red-600">
            If you receive an email, a call from a person/association claiming to be 9619915299 seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Usage</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Sharing</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Security Precautions</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Data Deletion and Retention</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Consent</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Changes to this Privacy Policy</h2>
          <p>
        ...
        <section className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="mb-2">
            <strong>Phone:</strong> 9619915299
          </p>
          <p className="mb-2">
            <strong>Time:</strong> Monday - Friday (9:00 - 18:00)
          </p>
          <p>
            <strong>Address:</strong> B48, KALPANA, Shree Mahalakshmi CHS, Veera Desai Road, Andheri W, Mumbai 400058
          </p>
        </section>
      </div>
    </div>
