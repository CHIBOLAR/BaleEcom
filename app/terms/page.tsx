      ...
      <div className="prose prose-lg max-w-none space-y-6">
        <section>
          <ol className="space-y-4 list-decimal list-inside">
            ...
            <li>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>playablegames.in</strong> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </li>
            <li>
              The Platform is owned by <strong>9619915299</strong>, a company incorporated under the Companies Act, 1956 with its registered office at <strong>B48, KALPANA, Shree Mahalakshmi CHS, Veera Desai Road, Andheri W, Mumbai 400058</strong> (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
            </li>
            <li>
        ...
        <section className="mt-8 space-y-4">
          <ol className="space-y-4 list-decimal list-inside">
            ...
            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Mumbai, India.</li>
